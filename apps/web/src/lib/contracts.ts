...
export const USDC_ADDRESS = (process.env.NEXT_PUBLIC_USDC_ADDRESS ??
  DEFAULT_USDC_ADDRESS) as `0x${string}`;
export const GENIE_ROUTER_ADDRESS = (process.env.NEXT_PUBLIC_GENIE_ROUTER_ADDRESS ??
  DEFAULT_GENIE_ROUTER_ADDRESS) as `0x${string}`;
